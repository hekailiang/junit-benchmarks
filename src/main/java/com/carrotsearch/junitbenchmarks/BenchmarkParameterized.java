...
/**
 * Created by kailianghe on 7/4/14.
 */
...
/**
 * <p>
 * The custom runner <code>BenchmarkParameterized</code> implements parameterized tests.
 ...
 *
 * <pre>
 * &#064;RunWith(BenchmarkParameterized.class)
 ...
 * <dd></dd>
 * </dl>
 * In the example given above, the <code>BenchmarkParameterized</code> runner creates
 ...
 * @since 4.0
 */
public class BenchmarkParameterized extends Suite {
    /**
    ...
    private class TestClassRunnerForParameters extends BenchmarkRunner {
     ...
     */
    public BenchmarkParameterized(Class<?> klass) throws Throwable {
